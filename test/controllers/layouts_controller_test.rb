...
class LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post layouts_url, params: { layout: { address: @layout.address, attendant: @layout.attendant, community_id: @layout.community_id, name: @layout.name, phone: @layout.phone } }
    end
  ...
  test "should update layout" do
    patch layout_url(@layout), params: { layout: { address: @layout.address, attendant: @layout.attendant, community_id: @layout.community_id, name: @layout.name, phone: @layout.phone } }
