...
class ContractStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract_status" do
    assert_difference('ContractStatus.count') do
      post contract_statuses_url, params: { contract_status: { description: @contract_status.description, name: @contract_status.name } }
    end
  ...
  test "should update contract_status" do
    patch contract_status_url(@contract_status), params: { contract_status: { description: @contract_status.description, name: @contract_status.name } }
